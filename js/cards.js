...
// カード定義。id = パワー
const CARDS = [
  { id: 0,  name: 'ねずみ小僧', kana: 'ねずみこぞう', text: '相手のパワーが10以上なら勝つ。', flavor: '大物ほど、盗みがいがある。' },
  { id: 1,  name: '提灯おばけ', kana: 'ちょうちんおばけ', text: '負けたとき、月光点は相手に渡らず持ち越しになる。', flavor: 'ふっ、と灯りが消えた。' },
  { id: 2,  name: '猫又', kana: 'ねこまた', text: '相手カードの能力を無効化する。', flavor: '化かし合いはお断りだにゃ。' },
  { id: 3,  name: '河童', kana: 'かっぱ', text: '負けたとき、自分は1点得る。', flavor: '転んでも皿の水はこぼさない。' },
  { id: 4,  name: '天狗', kana: 'てんぐ', text: '勝ったとき、追加で1点得る。', flavor: '勝って驕るは天狗の華よ。' },
  { id: 5,  name: '妖狐', kana: 'ようこ', text: 'このラウンドは強制的に引き分けになる（月光点は持ち越し）。', flavor: '勝負はお預け。月は逃げぬ。' },
  { id: 6,  name: '侍の霊', kana: 'さむらいのれい', text: '勝ったとき、次のラウンドの自分のカードのパワー+2。', flavor: '一太刀目は、二太刀目のために。' },
  { id: 7,  name: '巫女', kana: 'みこ', text: 'パワーが同点なら勝つ。', flavor: '神慮は常にわたしの側に。' },
  { id: 8,  name: '人狼', kana: 'じんろう', text: '満月のラウンドならパワー+5。', flavor: '月が満ちる。血が騒ぐ。' },
  { id: 9,  name: '大蛇', kana: 'おろち', text: '勝ったとき、相手の得点を1点奪う。', flavor: '呑まれたものは、還らない。' },
  { id: 10, name: '竜神', kana: 'りゅうじん', text: '能力なし。ただ純粋に強い。', flavor: '小細工は雲の下に置いてきた。' },
  { id: 11, name: '月読', kana: 'つくよみ', text: '能力なし。最高のパワー。', flavor: '夜のすべては我が管轄である。' },
];
